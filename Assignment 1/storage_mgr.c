 ...
 * Author 		: Aditya
 * Date			: 20.Feb.2015
 * Module		: initStorageManager
 * Description	: to initialise Global data in the subsequent enhancements.
 *
 */
 ...
 * Author 		: Aditya
 * Date			: 19.Feb.2015
 * Module		: getMeNthMetaData
 * Description	: gets the nth Key Value pair of MetaData;
 *
 */
 ...
 * Author 		: Karthik
 * Date			: 19.Feb.2015
 * Module		: constructMetaDataLinkedList
 * Description	: Construct the LinkedList of Maps which represents the metaData
 *
 */
		...
		int noOfNodesToBeConstructed)
{
	...
	char currentKey[50];
	memset(currentKey,'\0',51);

	char currentValue[50];
	memset(currentValue,'\0',51);
 ...
 * Author 		: Karthik
 * Date			: 19.Feb.2015
 * Module		: createPageFile
 * Description	: Used to either create pages or appendPages.
 * 				  AppendPage function will inturn invoke this method.
 *
 */
 ...
 * Date			: 13.Feb.2015
 * Module		: openPageFile
 * Description	: 1.Open a pageFile in readMode
 *
 2.If file exists, populate details of the file into fHandle struct
 and return RC_OK

 3.Else return RC_FILE_NOT_FOUND
 */
 ...
 * Description	: converts an Integer to an character Pointer
 */
 ...
 * Author 		: Unnikrishnan
 * Date			: 13.Feb.2015
 * Module		: writeMetaListOntoFile
 * Description	: To Write metaInfo to the file
 */
 ...
 * Date			: 13.Feb.2015
 * Module		: writeMetaListOntoFile
 * Description	: To write MetaData and close the PageFile
 */
 ...
 * Author 		: Aditya
 * Date			: 13.Feb.2015
 * Module		: destroyPageFile
 * Description	: Delete a pageFile from the hard disk.
 */
 ...
 * Date			: 13.Feb.2015
 * Module		: writeBlock
 * Description	: write the content of memPage to the file
 * 				  fHandle->fileName at the the block num pageNum.
 */
 ...
 * Author 		: Karthik
 * Date			: 14.Feb.2015
 * Module		: writeCurrentBlock
 * Description	: write the content of memPage to the file
 * 				  fHandle->fileName at the the block num fhandle->currentPagePos.
 */
 ...
 * Author 		: Karthik
 * Date			: 14.Feb.2015
 * Module		: appendEmptyBlock
 * Description	: To add an empty Block at EOF.
 */
 ...
 * Author 		: Karthik
 * Date			: 14.Feb.2015
 * Module		: ensureCapacity
 * Description	: To add (numberOfPages - fHandle->totalNumPages) no of Blocks at EOF.
 */
 ...
 * Date			: 13.Feb.2015
 * Module		: readBlock
 * Description	: 1. If pageNum is greater than the total number of pages in the
 Page File then return RC_READ_NON_EXISTING_PAGE.
 ...
 * Author 		: Aditya
 * Date			: 13.Feb.2015
 * Module		: readFirstBlock
 * Description	: Call readBlock and read the first block which is 0th block in the Page File.
 */
 ...
 * Author 		: Vivek
 * Date			: 13.Feb.2015
 * Module		: readPreviousBlock
 * Description	: Call readBlock and read the previous block using getBlockPos() - 1
 */
 ...
 * Author 		: Vivek
 * Date			: 13.Feb.2015
 * Module		: readCurrentBlock
 * Description	: Call readBlock and read the current block using getBlockPos()
 */
 ...
 * Author 		: Vivek
 * Date			: 13.Feb.2015
 * Module		: readNextBlock
 * Description	: Call readBlock and read the next block using getBlockPos() + 1
 */
 ...
 * Author 		: Vivek
 * Date			: 13.Feb.2015
 * Module		: readLastBlock
 * Description	: Call readBlock and read the last block which is (totalNumPages - 1)th block in the Page File.
 */
